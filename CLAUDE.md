# Bilibili Video Notes (tool entry · v1.1.8)
...
> Current version **v1.1.8**, kept in sync with `SKILL.md`; when SKILL.md changes this file is updated too. The endpoint auto-updater (`update_skill.py`) already lists this file in its whitelist.
